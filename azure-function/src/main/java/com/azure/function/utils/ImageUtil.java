package com.azure.function.utils;
...
/**
 * This util contains the logic to covert to remove gray
...
public final class ImageUtil {
	...
	private ImageUtil() {
		throw new IllegalStateException("ImageUtil class");
	}
	...
	public static void convert(InputStream inputStream, OutputStream outputStream, boolean enableCompression, String compressionType, int resolution, Logger logger) {
		try {
	...
	public static String convert(String source, String destination, boolean enableCompression, String compressionType, int resolution) {
		try {
